                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="../index.php">My Dashboards</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <?php
                                                $result = mysqli_query($con, "SELECT count(*) FROM user_service");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <?php
                                                $result = mysqli_query($con, "SELECT count(*) FROM userportfolio");
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <?php
                                                $result = mysqli_query($con, "SELECT count(*) FROM user_why_us");
                                                $rod = mysqli_fetch_row($result);
                                                $nud = $rod[0];
                                                ?>
                                                <p class="text-uppercase fw-semibold fs-12 text-muted mb-1"> Total Why Choose Us</p>

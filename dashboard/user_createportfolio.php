...
if($status=="OK")
{
$qb=mysqli_query($con,"INSERT INTO userportfolio (username ,port_title, port_desc, port_detail,ufile) VALUES ('$username','$port_title', '$port_desc', '$port_detail', '$new_file_name')");

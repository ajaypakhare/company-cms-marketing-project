                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">User Message</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">User Message</h5>
                                </div>
                                <div class="card-body">
                                <div>
                                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        ...
                                        <?php
				   $q="SELECT * FROM  contactinfo ORDER BY id ASC";
          ...
          <td>
                                                    <div class='dropdown d-inline-block'>
                                                        ...
                                                        <ul class='dropdown-menu dropdown-menu-end'>
                                                            <li>
                                                                <a href='contact-info-delete.php?id=$id' class='dropdown-item remove-item-btn'>
